%% Setup robot
speedRate = 0.6; % Constant that determines speed percentage
...
pause(1);
b1 = cross([-1; 0; 0], [-(l2z);0;(l4+l3+l2x)]);
% b2 = cross([0;-1;0], [-(l2z);0;(l4+l3+l2x)])
% b3 = cross([0;-1;0], [0;0;(l4+l3)])
% b4 = cross([0;-1;0], [0;0;(l3)])
bList = [[1; 0; 0; 0; 0.2902;0]...
         [0; 1; 0; -0.2902; 0; -0.1280]...
         [0; 1; 0;  -0.2662; 0; 0]...
         [0; 1; 0; -0.1207; 0; 0]];
